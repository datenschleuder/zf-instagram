...
/**
 * ZF-Instagram - Endpoint FollowedBy
 * 
 ...
 * @license    BSD
 */
final class ZendX_Instagram_Endpoints_Relationship_FollowedBy implements 
        ZendX_Instagram_Interfaces_Endpoint
{
     ...
     *
     * @param int $userid            
     * @return ZendX_Instagram_Endpoints_Relationship_FollowedBy
     */
    ...
    {
        return array(
                'endpointurl' => '/v1/users/' . $this->_userid . '/followed-by/',
                'method' => 'get'
        );
    }
} 